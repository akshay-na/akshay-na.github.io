...
If you'd like to **contribute** and make this much better for other users, have a look at [Issues](https://github.com/akshay-na/personal-portfolio/issues).

Created something awesome for your fork of the portfolio and want to share it? Feel free to open a [pull request](https://github.com/akshay-na/personal-portfolio/pulls).
...
- Navigate to `package.json` and enter your domain name instead of `https://akshay-na.github.io` in `homepage` variable. For example, if you want your site to be `https://<your-username>.github.io/repo_name`, add the same to the homepage section of `package.json`.
